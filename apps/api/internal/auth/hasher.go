...
// HashPassword creates an Argon2id hash of a password using standard RFC 9106 parameters.
...
// VerifyPassword checks if the provided plaintext password matches the Argon2id encoded hash.
